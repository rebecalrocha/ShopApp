  ...
  constructor (props) {
    ...
    handleOnSubmit = event => {
      ...
      if (this.state.cupon === 'LIVEN10') {
        ...
        const newTotal = this.state.totalPrice * 0.9
      ...
      return (
        <div className='text col-md-4 order-md-2 mb-4'>
          ...
          <ul className='list-group mb-3'>
            ...
            {this.state.usedCupon ? this.cupon : null}
          ...
          <div className='card p-2'>
            <div className='input-group'>
              ...
              <div className='input-group-append'>
                <button type='submit' onClick={this.handleOnSubmit} className='btn btn-secondary' disabled={this.state.usedCupon}>Redeem</button>
              </div>
            </div>
          </div>
        </div>
